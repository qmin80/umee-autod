...
func RecoverAccountFromMnemonic(mnemonic string, password string, bech32Prefix string) (string, *secp256k1.PrivKey, error) {
	...
	accAddr, err := bech32.ConvertAndEncode(bech32Prefix, pubKey.Address())
	if err != nil {
